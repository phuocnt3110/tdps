//@version=5
indicator("Minervini RS Crypto", shorttitle="RS_Crypto", overlay=false)

//----------------------------
// Inputs - CRYPTO VERSION
// Benchmark: CRYPTOCAP:TOTAL (Total Market Cap) or BTC for altcoin comparison
//----------------------------
benchmarkSymbol = input.symbol("CRYPTOCAP:TOTAL", "Benchmark (TOTAL or BTC)")
